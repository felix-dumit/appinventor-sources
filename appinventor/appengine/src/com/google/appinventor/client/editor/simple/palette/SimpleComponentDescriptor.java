...
import com.google.appinventor.client.editor.simple.components.MockNewComponent;
...
public final class SimpleComponentDescriptor {
  ...
  private static void initBundledImages() {
    ...
    bundledImages.put("images/newComponent.png", images.newComponent());
  ...
  public static MockComponent createMockComponent(String name, SimpleEditor editor) {
    ...
    } else if (name.equals(MockNewComponent.TYPE)) {
      return new MockNewComponent(editor);
    } else {
